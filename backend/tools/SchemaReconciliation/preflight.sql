...
DO $reconciliation$
DECLARE
    expected_model jsonb := $model$__MODEL_JSON__$model$::jsonb;
...
BEGIN
    ...
    IF serviceOwner_not_null_required THEN
        ...
        __SERVICE_OWNER_NOT_NULL_DDL__
    ELSE
